...
describe('GET /users/me', () => {
  ...
  it('should return a 401 if unauthenticated', (done) => {
    request(app)
      ...
      .expect(401)
      .expect((res) => {
        // Using '.toEqual()' since it works on Objects unlike '.toBe()''
...
describe('POST /users', () => {
  it('should create a user', (done) => {
    ...
    request(app)
      ...
      .expect(200)
      .expect((res) => {
        // Instead of 'res.headers.x-auth' we used this because when using '. notation', hypens aren't allowed
    ...
    request(app)
      ...
      .end((err, res) => {
        ...
        User.findById(users[1]._id).then((user) => {
          // 'toObject()' is needed for later version of expect library since it can't query thru mongoose's database otherwise
